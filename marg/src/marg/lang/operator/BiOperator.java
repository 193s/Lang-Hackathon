...
public enum BiOperator {
    ...
    private BiOperator(int level, String sign, BinaryOperator<MInt> func) {
        init(level, sign, (BiFunction)func);
    }
    private BiOperator(int level, String sign, BiFunction<MInt, MInt, MBool> func) {
